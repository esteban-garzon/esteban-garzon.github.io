...
<button onclick="window.location.href='{{ site.baseurl }}/international-journals/'">Journals</button> <button onclick="window.location.href='{{ site.baseurl }}/conferences/'">Conferences</button>  
